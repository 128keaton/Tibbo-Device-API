...
export declare class TibboTables {
     ...
     */
    getRows(deviceAddress: string, tableName: string, auth?: {
        username: string;
        password: string;
    }): Promise<import("./types").TibboRow[]>;
    /**
     ...
     */
    deleteRow(rowID: number, deviceAddress: string, tableName: string, auth?: {
        username: string;
        password: string;
    }): Promise<boolean>;
    /**
     ...
     */
    addRow(rowData: string, deviceAddress: string, tableName: string, auth?: {
        username: string;
        password: string;
    }): Promise<boolean>;
    /**
    ...
    addRowData(rowData: {
        [key: string]: any;
    }, deviceAddress: string, tableName: string, auth?: {
        username: string;
        password: string;
    }): Promise<boolean>;
    /** @internal **/
