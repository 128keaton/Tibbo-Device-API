...
export declare class TibboTables {
     ...
     */
    get(deviceAddress: string, devicePassword?: string): Promise<TibboTable[]>;
    /**
     ...
     */
    getRows(deviceAddress: string, tableName: string, devicePassword?: string): Promise<import("./types").TibboRow[]>;
    /**
     ...
     */
    deleteRow(rowID: number, deviceAddress: string, tableName: string, devicePassword?: string): Promise<boolean>;
    /**
     ...
     */
    addRow(rowData: string, deviceAddress: string, tableName: string, devicePassword?: string): Promise<boolean>;
    /**
    ...
    addRowData(rowData: {
        [key: string]: any;
    }, deviceAddress: string, tableName: string, devicePassword?: string): Promise<boolean>;
    /** @internal **/
    private _getTables;
    /** @internal **/
